package convenientfoundation.network.explosion;
...
public class ExtendedExplosion extends Explosion {
    ...
    public ExtendedExplosion(World world, Entity entityIn, double x, double y, double z, float size, List<BlockPos> affectedPositions)
    {
        this(world, entityIn, x, y, z, size, false, true, affectedPositions);
    }

    @SideOnly(Side.CLIENT)
    public ExtendedExplosion(World world, Entity entityIn, double x, double y, double z, float size, boolean flaming, boolean smoking, List<BlockPos> affectedPositions)
    {
        this(world, entityIn, x, y, z, size, flaming, smoking);
        this.affectedBlockPositions.addAll(affectedPositions);
    }

    public ExtendedExplosion(World world, Entity entityIn, double x, double y, double z, float size, boolean flaming, boolean smoking)
    {
    	super(world, entityIn, x, y, z, size, flaming, smoking);
        this.explosionRNG = world.rand;
    ...
    public static Explosion newExplosion(ExtendedExplosion e)
    {
        ...
        for (EntityPlayer entityplayer : e.getWorld().playerEntities)
        {
            ...
            {
                ModNetworking.INSTANCE.sendTo(new PacketExtendedExplosion(e.explosionX, e.explosionY, e.explosionZ, e.size, e.getAffectedBlockPositions(), (Vec3d)e.getPlayerKnockbackMap().get(entityplayer)),(EntityPlayerMP)entityplayer);
            }
        }
